...
var pJS = function (e, a) {
  ...
  (a && Object.deepExtend(i, a), i.tmp.obj = {
    ...
    var t = e.x - a.x, s = e.y - a.y, n = Math.sqrt(t * t + s * s);
    if (n <= i.particles.line_linked.distance) {
      var r = t / (1000 * i.particles.move.attract.rotateX), c = s / (1000 * i.particles.move.attract.rotateY);
    ...
    if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
      ...
      if (i.tmp.bubble_clicking) {
        var s = e.x - i.interactivity.mouse.click_pos_x, n = e.y - i.interactivity.mouse.click_pos_y, r = Math.sqrt(s * s + n * n), p = (new Date().getTime() - i.interactivity.mouse.click_time) / 1000;
    ...
    if (i.particles.number.density.enable) {
      var e = i.canvas.el.width * i.canvas.el.height / 1000;
